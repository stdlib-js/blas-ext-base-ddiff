...
});var L=I(function(d,T){
var K=require('@stdlib/blas-base-dcopy/dist').ndarray,J=S();function k(n,q,g,h,j,z,C,_,m,E,B,R,l,i,b,D,a,r,c){var v,F,G,y;if(v=n+z+E,v<=1||q>=v)return i;if(q===0)return K(z,C,_,m,i,b,D),F=D+z*b,K(n,g,h,j,i,b,F),F=D+(z+n)*b,K(E,B,R,l,i,b,F),i;if(q===1)return J(n,g,h,j,z,C,_,m,E,B,R,l,i,b,D),i;for(J(n,g,h,j,z,C,_,m,E,B,R,l,a,r,c),G=v-1,y=1;y<q-1;y++)J(G,a,r,c,0,C,_,m,0,B,R,l,a,r,c),G-=1;return J(G,a,r,c,0,C,_,m,0,B,R,l,i,b,D),i}T.exports=k
